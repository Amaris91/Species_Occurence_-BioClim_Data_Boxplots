...
points(x = 4, y = 16, col = 'orange', cex = 1, pch = 16)

Pseudo_intricata_10_RCP8.5_2080 <- 16.1
points(Pseudo_intricata_10_RCP8.5_2080)
points(x = 3, y = 16.1, col = 'orange', cex = 1, pch = 16)
...
points(x = 1, y = 16.8, col = 'orange', cex = 1, pch = 16)
...
points(x = 4, y = 15.5, col = 'purple', cex = 1, pch = 16)

Pseudo_intricata_10_RCP8.5_2060 <- 15.6
points(Pseudo_intricata_10_RCP8.5_2060)
points(x = 3, y = 15.6, col = 'purple', cex = 1, pch = 16)
...
points(x = 1, y = 16.1, col = 'purple', cex = 1, pch = 16)
...
points(x = 2, y = 15.7, col = 'purple', cex = 1, pch = 16)
...
points(x = 2, y = 281, col = 'orange', cex = 1, pch = 16)

Pseudo_intricata_18_RCP8.5_2080 <-383
points(Pseudo_intricata_18_RCP8.5_2080)
points(x = 3, y = 383, col = 'orange', cex = 1, pch = 16)
...
points(x = 1, y = 340, col = 'orange', cex = 1, pch = 16)
...
points(x = 4, y = 345, col = 'orange', cex = 1, pch = 16)
...
points(x = 2, y = 425, col = 'purple', cex = 1, pch = 16)

Pseudo_intricata_18_RCP8.5_2060 <- 430
points(Pseudo_intricata_18_RCP8.5_2060)
points(x = 3, y = 430 , col = 'purple', cex = 1, pch = 16)
...
points(x = 1, y = 379, col = 'purple', cex = 1, pch = 16)
...
points(x = 4, y = 385, col = 'purple', cex = 1, pch = 16)
...
points(x = 2, y = 774, col = 'orange', cex = 1, pch = 16)

Pseudo_intricata_16_RCP8.5_2080 <-783
points(Pseudo_intricata_16_RCP8.5_2080)
points(x = 3, y = 783, col = 'orange', cex = 1, pch = 16)
...
points(x = 1, y = 712, col = 'orange', cex = 1, pch = 16)
...
points(x = 4, y = 713, col = 'orange', cex = 1, pch = 16)
...
points(x = 2, y = 731, col = 'purple', cex = 1, pch = 16)

Pseudo_intricata_16_RCP8.5_2060 <- 733
points(Pseudo_intricata_16_RCP8.5_2060)
points(x = 3, y = 733, col = 'purple', cex = 1, pch = 16)
...
points(x = 1, y = 661, col = 'purple', cex = 1, pch = 16)
...
points(x = 4, y = 672, col = 'purple', cex = 1, pch = 16)
...
pdf('/Users/S2128839/OneDrive - University of Edinburgh/Boxplots/UK/Bio_08_UK.pdf', width=8, height=6)
par(mar = c(12,5,2,1))
boxplot(Climate_Data_UK_All_Species$Bio_08 ~ Bio_08_reordered_UK, outline=FALSE, ylab= 'Temperature [°C]', xlab = '', col="#009b7d", boxwex=0.5 , main="UK Bio 08", las = 2)
par(mar = c(12,5,2,1))
abline (h=6.309393, col ='Blue', lwd=3)
...
par(mar = c(12,5,2,1))
pdf('/Users/S2128839/OneDrive - University of Edinburgh/Boxplots/UK/Bio_08_Indovidual_Means.pdf', width=8, height=6)
boxplot(Climate_Data_UK_All_Species$Bio_08 ~ Bio_08_reordered_UK, outline=FALSE, ylab= 'Temperature [°C]', xlab = '', col="#009b7d", boxwex=0.5 , main="UK Bio 08", las = 2)
par(mar = c(12,5,2,1))
dev.off()
abline (h=6.309393, col ='Blue', lwd=3)
...
points(x = 5, y = 6.8, col = 'orange', cex = 1, pch = 16)
...
points(x = 4, y = 6.9, col = 'orange', cex = 1, pch = 16)
...
points(x = 5, y = 9, col = 'purple', cex = 1, pch = 16)
...
points(x = 4, y = 9.3, col = 'purple', cex = 1, pch = 16)
